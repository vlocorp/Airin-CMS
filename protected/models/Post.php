 ...
 */
class Post extends VAbstractActiveRecord {
    public $image; 
    ...
    public function rules() {
        ...
        return array(
            ...
            array('user_id, category_id, sub_category_id, hide, active, sort, hot', 'numerical', 'integerOnly' => true),
            array('title, image', 'length', 'max' => 256),
            array('create_time, update_time', 'safe'),
            array('image', 'file', 'types' => 'jpg, gif, png, jpeg', 'allowEmpty' => true),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, user_id, category_id, sub_category_id, title, content, hide, active, sort, hot, image, create_time, update_time', 'safe', 'on' => 'search'),
        );
    }
